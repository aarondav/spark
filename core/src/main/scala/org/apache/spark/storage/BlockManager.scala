...
private[spark] class BlockManager(
  ...
  // TODO: Make false!
  private[spark]
  val externalShuffleServiceEnabled = conf.getBoolean("spark.shuffle.service.enabled", true)
  private val externalShuffleServicePort = conf.getInt("spark.shuffle.service.port", 7337)
  if (externalShuffleServiceEnabled) {
    require(blockTransferService.isInstanceOf[NettyBlockTransferService],
      "External shuffle service requires spark.shuffle.blockTransferService to be 'netty'")
  }
